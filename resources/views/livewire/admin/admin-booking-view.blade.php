<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('pdf.generate', $booking->booking_id) }}" type="submit" class="px-4 py-2 rounded-md border text-sm
                    bg-white text-gray-700
                    hover:bg-gray-100
                    dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600
                    dark:hover:bg-gray-700">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-3">
            ...
            <select wire:model="status" class="w-full h-11 px-3 rounded-md border
            ...
            <button wire:click="updateStatus" class="w-full px-4 py-2 rounded-md bg-indigo-600 text-white">
                Update Status
            </button>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-3">
            ...
            <select wire:model="assigned_to" class="w-full h-11 px-3 rounded-md border
                    bg-white text-gray-800
                    dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600">
            ...
            <button wire:click="assignTechnician" class="w-full px-4 py-2 rounded-md bg-blue-600 text-white">
                Assign
            </button>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-4">
            ...
            <input type="number" wire:model="total_amount" placeholder="Enter final amount" class="w-full h-11 px-3 rounded-md border
                    bg-white dark:bg-gray-700 dark:text-white">

            <select wire:model="payment_method" class="w-full h-11 px-3 rounded-md border
                    bg-white dark:bg-gray-700 dark:text-white">
            ...
            <button wire:click="updateAmount" class="px-4 py-2 rounded-md bg-emerald-600 text-white">
                Save Payment
            </button>
        </div>
        <!-- ADMIN NOTE -->
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-3">
            ...
            <textarea wire:model="admin_note" class="w-full h-28 px-3 py-2 rounded-md border
                       bg-white text-gray-800
                       dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600">
            </textarea>

            <button wire:click="saveAdminNote" class="px-4 py-2 rounded-md bg-green-600 text-white">
                Save Note
            </button>
        </div>
